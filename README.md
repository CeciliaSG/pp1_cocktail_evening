...
- ### User stories
  ...
  - #### Frequent User Goals
        ...
        Are not really relevant forthis site.

- ### Design
  - #### Colour Scheme
    - Two main colours, pink and red,complemented by white used mainly for background and some text, and purple colour for the footer
  - #### Typography
  - Poppins and Libre  Baskerville.
